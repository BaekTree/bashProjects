...
randomize(){
    ...
    do
        ...
        do
            # echo -e "${ruleArrR[$i]}"
            ruleArrRnd+=("${ruleArr[$i]}")
            contArrRnd+=("${contArr[$i]}")
            ansArrRnd+=("${ansArr[$i]}")
            limitArrRnd+=("${limitArr[$i]}")
            completeArrRnd+=("${completeArr[$i]}")
            msgArrRnd+=("${msgArr[$i]}")
        done
    done
    priorIFS=$IFS
    ...
    contArrR=("${contArrRnd[@]}")
    ansArrR=("${ansArrRnd[@]}")
    limitArrR=("${limitArrRnd[@]}")
    completeArrR=("${completeArrRnd[@]}")
    msgArrR=("${msgArrRnd[@]}")
